  ...
  return (
    <div className="relative bg-slate-900 min-h-screen flex items-center justify-center overflow-hidden">
      ...
      >
        ...
        <h1 className="font-medium text-4xl text-cyan-400 tracking-wider">
          Benoit Garcia
        </h1>
        <p className="font-light text-sm text-slate-100 tracking-widest">
          ...
          <li className="flex items-center">
            <Link href="https://github.com/benysserp">
              <a
                aria-label="GitHub"
                target="_blank"
                className="transition-all duration-200 bg-slate-200 text-slate-900 hover:bg-stone-600 hover:text-white p-2 rounded-full"
              >
                <FaGithub />
              </a>
            </Link>
          ...
          <li className="flex items-center">
            <Link href="https://twitter.com/PressyDev">
              <a
                aria-label="Twitter"
                target="_blank"
                className="transition-all duration-200 bg-slate-200 text-slate-900 hover:bg-cyan-500 hover:text-white p-2 rounded-full"
              >
                <FaTwitter />
              </a>
            </Link>
          ...
          <li className="flex items-center">
            <Link href="https://www.twitch.tv/pressycw">
              <a
                aria-label="Twitch"
                target="_blank"
                className="transition-all duration-200 bg-slate-200 text-slate-900 hover:bg-purple-500 hover:text-white p-2 rounded-full"
              >
                <FaTwitch />
              </a>
            </Link>
          ...
          <li className="flex items-center">
            <Link href="https://www.linkedin.com/in/benoit-gar/">
              <a
                aria-label="Linkedin"
                target="_blank"
                className="transition-all duration-200 bg-slate-200 text-slate-900 hover:bg-sky-600 hover:text-white p-2 rounded-full"
              >
                <FaLinkedin />
              </a>
            </Link>
          ...
          <li className="flex items-center">
            <Link href="mailto:benoitgar.pro@gmail.com">
              <a
                aria-label="Email"
                target="_blank"
                className="transition-all duration-200 bg-slate-200 text-slate-900 hover:bg-rose-500 hover:text-white p-2 rounded-full"
              >
